...
function CharactersRotation() {
    //debugger;
    console.log("Invoked CharactersRotation()");     //console.log your BFF for debugging client side - also use debugger statement
    const url = "/Characters/Rotation/";    		// API method on web server will be in Users class, method list
    fetch(url, {
        method: "GET",				//Get method
    }).then(response => {
        return response.json();                 //return response as JSON
